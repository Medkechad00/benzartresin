...
/**
 * Our Craft — the merged brand story and process page.
 *
 * This replaces two pages that were both thin and overlapping, and whose naming
 * actively contradicted itself: /about had the H1 "Atelier." while its nav label
 * read "Studio", and /craftsmanship had the H1 "The Process." while its nav
 * label read "Atelier". A visitor could not tell them apart, and the two pages
 * competed for the same craftsmanship keywords.
 *
 * Merging concentrates that authority on one URL and gives the site a single,
 * obvious "who we are and how we work" destination. Old paths 301 to here — see
 * next.config.ts.
 */
...
/** Fixed assets; only the prose and alt text are translated. */
const PHASE_IMAGES = [
      ...
      <div className="w-full px-6 md:px-12 py-16 md:py-24">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 items-start">
          ...
          <div className="lg:w-2/3 flex flex-col min-w-0">
            ...
            {/* --- Process, merged in from the old /craftsmanship page --- */}
            <motion.h2
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
